...
# sphinx-quickstart on Sun Nov 14 00:29:15 2010.
#
...
# default setting in mathjax.py is: [r'\(', r'\)']
mathjax_inline = ['$', '$']
# default setting in mathjax.py is: [r'\[', r'\]']
mathjax_display = ['$$', '$$']
...
copyright = u'2010, Abhishek Tiwari'
...
latex_documents = [
  ('index', 'Sphinx.tex', u'Knowledge Base',
   u'Abhishek Tiwari', 'manual'),
]
